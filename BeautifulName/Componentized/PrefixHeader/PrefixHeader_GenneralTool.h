...
#define MainBundle(__name, __owner, __index)              ([[NSBundle mainBundle] loadNibNamed:__name owner:__owner options:@{}][__index])
#define NibController(__controller)                       ([[__controller alloc] initWithNibName:NSStringFromClass([__controller class]) bundle:[NSBundle mainBundle]])
...
#define kDevice_Is_iPhoneXR ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(1125, 2436), [[UIScreen mainScreen] currentMode].size) : NO)
